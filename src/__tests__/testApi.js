...
describe('1. Boards with good inputs', () => {
    it('Test 1.1 POST /api/plays, bot is X player and the play will be to win the game', done => {
        /*
        | X |   | O |           | X |   | O |
    ...
    it('Test 1.3 POST /api/plays, bot is X player and receives a full fillen board with a draw game', done => {
        /*
        | X | X | O |           | X | X | O |
        | O | O | X |   -->     | O | O | X |   -->     DRAW 
        | X | O | X |           | X | O | X |
...
describe('2. Boards with bad inputs', () => {
    it('Test 2.1 POST /api/plays, bot side is not send to API', done => {
        /*
        | X |   | O |
        | O | X | O |
        |   | X |   |
    ...
    it('Test 2.2 POST /api/plays, board is not a 3x3 size', done => {
        const body = {
            board: ["X", "", "O", "O", "X", "O", "", "X"],
            isBotX: true
        };
    ...
    it('Test 2.3 POST /api/plays, board positions are not X, O or ""', done => {
        const body = {
            board: ["A", "", "B", "C", "D", "E", "", "f", ""],
            isBotX: true
        };
    ...
    it('Test 2.4 POST /api/plays, board positions are not X, O or ""', done => {
        const body = {
    ...
    it('Test 2.5 POST /api/plays, isBotX field is not a boolean parameter', done => {
        const body = {
            board: ["X", "", "", "", "", "", "", "", ""],
            isBotX: "yes"
        };
